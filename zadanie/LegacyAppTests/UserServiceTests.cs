...
public class UserServiceTests
{
    ...
    public void AddUser_Should_Return_False_When_Missing_FirstName()
    {
        ...
        //Act
        bool result = service.AddUser(null, "Doe", "s28610@pjwstk.edu.pl", new DateTime(1890, 1, 1), 1);
    ...
    public void AddUser_Should_Return_False_When_Younger_Then_21_Years_Old()
    {
        ...
        //Act
        var result = service.AddUser("John", "Doe", "s28610@pjwstk.edu.pl", new DateTime(2014, 1, 1), 1);
    ...
    public void AddUser_Should_Throw_Exception_When_User_Does_Not_Exist()
    {
        ...
        {
            _ = service.AddUser("John", "Unknown", "kowalski@wp.pl", new DateTime(1980, 1, 1), 10);
        });
    }
